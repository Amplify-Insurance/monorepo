...
export default function ManageCoverageModal({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={`Manage ${type === "coverage" ? "Coverage" : "Position"} - ${protocol} ${token}`}
    >
      <div className="space-y-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
          ...
          <div className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            {type === "coverage" ? "Premium" : "Yield"}: {type === "coverage" ? premium : underwriterYield}% APY
          </div>
        </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400">
              ...
              <span className="hidden sm:inline">Enter the amount of {token}</span>
            </div>
          </div>
